...
char *menu[] = {"View Log","Clear Log","Download Log ","Set Time ","ChangePassword"};
...
char change_time( unsigned char key ,unsigned char reset_time )
{
 ...
 if ( wait ++ == 50 )
 {
  wait = 0;
  blink = !blink;
  clcd_putch( new_time[0] / 10 + 48, (0xC0 + 0));
  clcd_putch( new_time[0] % 10 + 48 , (0xC0 + 1));
  clcd_putch( ':', (0xC0 + 2));
  clcd_putch( new_time[1] / 10 + 48, (0xC0 + 3));
  clcd_putch( new_time[1] % 10 + 48, (0xC0 + 4));
  clcd_putch( ':', (0xC0 + 5));
  clcd_putch( new_time[2] / 10 + 48 , (0xC0 + 6));
  clcd_putch( new_time[2] % 10 + 48, (0xC0 + 7));
