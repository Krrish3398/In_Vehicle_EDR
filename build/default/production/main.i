...
void main(void) {
    ...
    while (1) {
        ...
        else if((key == 0x37 || key == 0x2F) && (control_flag == 0x01))
       {
        ...
        else if ( key == 0x11 && control_flag == 0x04 )
  {
   ...
   switch ( menu_pos )
   {
    ...
    case 4:
     ...
     break;
        ...
        else if ( key == 0x22 && (control_flag == 0x04 ||control_flag == 0x08))
            {
                control_flag = 0x01;
                clcd_write(0x01, 0);
            }
        else if ( key == 0x11 && control_flag == 0x08 )
            {
                control_flag = 0x04;
                clcd_write(0x01, 0);
            }
   ...
   case 0x40 :
    ...
    if ( change_time( key ,reset_flag ) == 0x11 )
     wait_time = 100;
