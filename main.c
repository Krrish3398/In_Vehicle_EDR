 ...
 * Project : Car Black Box Implementation
 *
 * Created on 23 August, 2022, 11:52 PM
 */
...
void main(void) {
    ...
    int wait_time = 0;
    init_config();
    log_car_event(event,speed);//To log the initial state of car event and the speed in the EEprom 
